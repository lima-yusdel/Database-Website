...
<%
	...
	}else
	{
		...
		LocalDate dateBefore = userDate.minusDays(1);
		LocalDate dateAfter = userDate.plusDays(2);
		
		System.out.print("Day before: " + dateBefore.toString());
		System.out.print("Day after: "+ dateAfter.toString());
		
		String query = "SELECT * " +
				"FROM flight f " +
				"Where f.departCity = ? " + 
				"and f.arriveCity = ? " +
				"and departsDateTime between '"+dateBefore.toString()+ "' And '"+ dateAfter.toString() +"'" +
				" union " +
				 "SELECT * " +
				 "FROM flight f " +
				 "Where f.departCity = ? " + 
...
<body>	
	<div class="limiter">
		...
		<div class="wrap-login p-l-25 p-r-55 p-t-65 p-b-50">
			<a href="index.jsp">Log out</a>
			<br>
			<span class="login-form-title p-b-33">
				Flights 
			</span>
			<div class="text-align:center fs-14 p-b-20 p-t-5 p-r-10">
			</div>
